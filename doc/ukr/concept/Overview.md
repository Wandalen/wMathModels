...
Деякі комбіанції значень кутів поворота ( йдетьяс про перших 3-ри скаляри ) є проблемними. [Гімбал лок](https://en.wikipedia.org/wiki/Gimbal_lock) може виникати заблокувавши можливість обертання в 3-ій розмірності.
