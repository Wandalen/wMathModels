...
Обертання об'єкта за кутами еулера. Один із можливих способів задати обертання. Екземпляр моделі зберігається в будь-якій формі вектора.
...
Обертання об'єкта з використанням кватерніонів. Один із можливих способів задати обертання. Екземпляр моделі зберігається в будь-якій формі вектора.
