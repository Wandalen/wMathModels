...
На рисунку відображено фігуру "LinePointDir" у двох вимірному просторі.
<!-- ![LinePointDir.png](../img/LinePointDir.png) -->

На рисунку відображено як дані фігури "LinePointDir" зберігаються в памяті процесу
<!-- ![LinePointDirMemory.png](../img/LinePointDirMemory.png) -->
...
Як читати дані фігури записаної у вигляді одновимірного масиву

...

Як отримати дані про фігуру, на прикладі "linePointDir".
