...
Фігуру можна створити на основі розмірності або вже існуючої моделі цього ж типу.
Якщо передано існуючу фігуру, то нова модель буде її копією.
...
Приклад перетворення моделі `linePoints` в `linePointDir` та обчислення точки перетину двох фігур.
