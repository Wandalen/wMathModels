...
var srcXYX = [ 0.1, 0, 0, 0, 1, 0 ];
var srcXZX = [ 0.1, 0, 0, 0, 2, 0 ];
var srcYXZ = [ 0, 1.570796327, 0, 1, 0, 2 ];
var srcYZX = [ 0, 1.570796327, 0, 1, 2, 0 ];
var srcYXY = [ 0.1, 0, 0.1, 1, 0, 1 ];
var srcYZY = [ 0.1, 0, 0, 1, 2, 1 ];
var srcZYX = [ 0, 1.570796327, 0, 2, 1, 0 ];
var srcZXY = [ 0, 1.570796327, 0, 2, 0, 1 ];
var srcZXZ = [ 0, 0, 0, 2, 0, 2 ];
var srcZYZ = [ 0, 0, 0, 2, 1, 2 ];
...
console.log( 'euler from quat ZXZ :', euler );
