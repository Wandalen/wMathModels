...
function fromQuat2( quat, dst )
{
  ...
  if( ox === 0 && oy === 1 && oz === 2 )
  {
    ...
    else if( 2*( x*z + w*y ) === - 1 )
    {
      ...
      dstv.eSet( 2, atan2( ( y*z + w*x ), ( x*z - w*y ) ) );
      dstv.eSet( 1, - pi/2 );
      dstv.eSet( 0, 0 );
    }
    else if( 2*( x*z + w*y ) === 1 )
  ...
  if( ox === 0 && oy === 2 && oz === 1 )
  {
    ...
    else if( 2*( x*z - w*y ) === - 1 )
    {
      ...
      dstv.eSet( 2, atan2( ( y*z - w*x ), ( x*y + w*z ) ) );
      dstv.eSet( 1, pi/2 );
      dstv.eSet( 0, 0 );
    }
    else if( 2*( x*z - w*y ) === 1 )
  ...
  if( ox === 1 && oy === 2 && oz === 0 )
  {
    ...
    {
      console.log('Indeterminate; We set angle x = 0. ');
      dstv.eSet( 2, atan2( ( x*z + w*y ), ( y*x - w*z ) ) );
      dstv.eSet( 1, - pi/2 );
      dstv.eSet( 0, 0 );
    }
    else if( ( 2*y*z - 2*w*x ) === 1 )
  ...
  if( ox === 2 && oy === 0 && oz === 1 )
  {
    ...
    {
      console.log('Indeterminate; We set angle x = 0. ');
      dstv.eSet( 2, atan2( ( x*y + w*z ), ( y*z - w*x ) ) );
      dstv.eSet( 1, - pi/2 );
      dstv.eSet( 0, 0 );
    }
    else if( ( 2*y*z + 2*w*x ) === 1 )
  ...
  if( ox === 2 && oy === 1 && oz === 0 )
  {
    ...
    {
      console.log('Indeterminate; We set angle x = 0. ');
      dstv.eSet( 2, atan2( ( x*y - w*z ), ( x*z + z*y ) ) );
      dstv.eSet( 1, pi/2 );
      dstv.eSet( 0, 0 );
    }
    else if( 2*( x*z - w*y ) === 1 )
